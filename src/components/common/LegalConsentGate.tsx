...
export const LegalConsentGate: React.FC<LegalConsentGateProps> = ({ onAccept, onNavigate }) => {
  ...
  return (
    <section className="min-h-screen w-full bg-[#F8FAFF] text-right" dir="rtl">
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="w-full bg-white border border-slate-200 sm:rounded-3xl shadow-none overflow-hidden">
          <div className="px-5 sm:px-8 lg:px-10 py-7 sm:py-9 border-b border-slate-100">
