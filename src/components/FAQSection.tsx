...
const FAQ_ITEMS = [
  ...
  {
    q: 'هل توجد إشعارات من الموقع نفسه غير الواتساب؟',
    a: 'نعم، منصة حصتي بتبعت إشعارات فورية لمتصفحك (Web Push) بنفس سرعة إشعارات الواتساب: تأكيد الحجوزات، الحضور بالـ QR، الدفعات، والدرجات — تقدر تفعّلها من الموقع بضغطة واحدة حتى لو الموقع مقفول، وبدون أي تكلفة.',
  },
  {
    q: 'هل منصة حصتي متاحة في كل محافظات مصر؟',
    a: 'نعم، المنصة متاحة لكل محافظات مصر: القاهرة والجيزة والإسكندرية والدلتا والصعيد. تقدر تبحث عن مدرس معتمد في منطقتك بالضبط وتحجز حصة أونلاين أو حضوري حسب المتاح.',
  },
  {
    q: 'كيف أتواصل مع خدمة دعم منصة حصتي؟',
    a: 'فريق الدعم متاح يومياً من 9:00 صباحاً حتى 10:00 مساءً عبر تليجرام على الحسابين @MCV_M و@MCV_W أو عبر البريد الإلكتروني hasstysupport@gmail.com.',
  },
];
