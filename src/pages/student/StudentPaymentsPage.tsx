  ...
  return (
    <div className="space-y-8 text-right">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-5 space-y-1">
          <span className="text-xs font-bold text-[#6B7280]">اشتراك الشهر الحالي (أغسطس)</span>
          <p className="text-2xl font-black text-[#2563EB] font-mono">1,350 ج.م</p>
          <span className="text-[11px] text-[#2563EB] font-bold">مسدد بالكامل ✓</span>
        </div>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-5 space-y-1">
          ...
          <span className="text-[11px] text-[#6B7280]">لا توجد متأخرات</span>
        </div>
      </div>
