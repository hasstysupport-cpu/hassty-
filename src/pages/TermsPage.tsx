    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl shadow-sm p-6 sm:p-10">
        ...
        <div className="space-y-8 text-sm leading-8">
          ...
          <section><h2 className="text-lg font-black text-[#1E3A8A] mb-2">11) التواصل القانوني</h2><p>للاستفسارات المتعلقة بالشروط أو طلبات الحقوق القانونية والبيانات: تواصل معنا عبر <a className="text-blue-600 font-bold hover:underline" href="https://t.me/+-gGdGyw60wA2MDRk" target="_blank" rel="noreferrer">جروب الدعم على تليجرام</a> أو <a className="text-blue-600 font-bold hover:underline" href="https://chat.whatsapp.com/DDU2o4jiLASAcVeEb6BnNu" target="_blank" rel="noreferrer">جروب الدعم على واتساب</a>.</p></section>
        </div>
