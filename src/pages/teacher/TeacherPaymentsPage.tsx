    ...
    <div className="space-y-8 text-right">
      ...
      <div className="bg-gradient-to-l from-[#1E3A8A] to-[#2563EB] text-white rounded-3xl p-6 sm:p-8 shadow-md space-y-6">
        ...
        <div className="p-4 bg-white/10 rounded-2xl border border-white/20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
          <div>
            <span className="text-blue-200">إجمالي إيراد الشهر ({totalStudents} طالب): </span>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6 sm:p-8 space-y-5 shadow-xs">
        <div className="flex items-center justify-between">
          <h3 className="text-base font-bold text-[#1E3A8A]">سجل اشتراكات الطلاب</h3>
          <span className="text-xs text-[#6B7280]">
            إجمالي الطلاب المسجلين: <strong className="text-[#10B981]">{totalStudents}</strong>
          </span>
        </div>
        ...
        {students.length > 0 ? (
          ...
          <div className="text-center py-12 space-y-2">
            ...
            <p className="text-xs font-bold text-gray-600">لا توجد عمليات تحصيل مسجلة بعد</p>
            <p className="text-[11px] text-gray-400">ستظهر هنا سجلات الاشتراكات فور قيد الطلاب وتحصيل الرسوم</p>
          </div>
        )}
      </div>
