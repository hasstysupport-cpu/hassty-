...
export default function App(){
 ...
 useEffect(()=>{const robots=document.querySelector('meta[name="robots"]');if(isAdminAppRoute){document.title='لوحة الإدارة | منصة حصتي';if(robots)robots.setAttribute('content','noindex, nofollow')}else if(isDashboardRoute){document.title=`${dashboardTitles[currentPath]||'لوحة التحكم'} | منصة حصتي`;if(robots)robots.setAttribute('content','noindex, nofollow')}},[currentPath,isDashboardRoute,isAdminAppRoute]);
