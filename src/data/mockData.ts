...
export const SAMPLE_TUTORS: TutorProfile[] = [
  ...
  {
    id: 't7',
    name: 'أ. محمود عبد الجواد',
    title: 'كبير معلمي الرياضيات والإحصاء للثانوية العامة',
    subject: 'الرياضيات',
    ...
    bio: 'خبرة 15 عاماً في تدريس فروع الرياضيات البحتة والتطبيقية بمدينة شبين الكوم ومراكز المنوفية.',
    experienceYears: 15,
    centers: ['سنتر التفوق - شبين الكوم', 'أكاديمية النجاح - منوف'],
    phone: '01033445566',
    email: 'mahmoud.math@hassty.edu',
    education: 'بكالوريوس علوم وتربية - قسم رياضيات جامعة المنوفية',
    reviews: SAMPLE_REVIEWS,
    availableSlots: DEFAULT_SLOTS
  }
];
